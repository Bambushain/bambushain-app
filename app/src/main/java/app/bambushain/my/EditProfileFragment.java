...
import app.bambushain.databinding.FragmentEditProfileBinding;
...
@AndroidEntryPoint
public class EditProfileFragment extends BindingFragment<FragmentEditProfileBinding> {
    ...
    @Override
    protected FragmentEditProfileBinding getViewBinding() {
